...
arr_f8_3d: onp.Array3D[np.float64]
...
f_kron_f8_3d = kron(arr_f8_3d, arr_f8_3d)  # pyright: ignore[reportDeprecated]
assert_type(f_kron_f8_2d, onp.Array2D[np.float64])
assert_type(f_kron_f8_3d, onp.Array[onp.AtLeast2D, np.float64])
###
...
assert_type(toeplitz(arr_f8_2d), onp.Array2D[np.float64])  # pyright: ignore[reportDeprecated]
assert_type(toeplitz(arr_f8_3d), onp.Array2D[np.float64])  # pyright: ignore[reportDeprecated]
assert_type(toeplitz(arr_f8_3d, arr_f8_3d), onp.Array2D[np.float64])  # pyright: ignore[reportDeprecated]
###
