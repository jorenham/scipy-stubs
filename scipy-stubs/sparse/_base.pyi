...
class _spbase(Generic[_SCT_co]):
    ...
    #
    def __add__(self, rhs: Untyped, /) -> Untyped: ...
    def __radd__(self, lhs: Untyped, /) -> Untyped: ...
    def __sub__(self, rhs: Untyped, /) -> Untyped: ...
    def __rsub__(self, lhs: Untyped, /) -> Untyped: ...
    #
    def __mul__(self, rhs: Untyped, /) -> Untyped: ...
    def __rmul__(self, lhs: Untyped, /) -> Untyped: ...
    def __pow__(self, rhs: op.CanIndex, /) -> Self: ...
    #
    def __matmul__(self, rhs: Untyped, /) -> Untyped: ...
    def __rmatmul__(self, lhs: Untyped, /) -> Untyped: ...
    #
    def __truediv__(self, rhs: Untyped, /) -> Untyped: ...
    def __div__(self, lhs: Untyped, /) -> Untyped: ...  # que?
