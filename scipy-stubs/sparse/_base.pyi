...
class _spbase(Generic[_SCT_co, _ShapeT_co]):
    ...
    @overload
    def __lt__(self: _SpArray1D, other: _spbase[_ToFloat, tuple[int]] | onp.ToFloat, /) -> csr_array[np.bool_, tuple[int]]: ...
    @overload
    def __lt__(
        self: _SpArray2D,
        other: _spbase[_ToFloat, tuple[int, int]] | onp.ToFloat,
        /,
    ) -> csr_array[np.bool_, tuple[int, int]]: ...
    @overload
    ...
    @overload
    def __gt__(self: _SpArray1D, other: _spbase[_ToFloat, tuple[int]] | onp.ToFloat, /) -> csr_array[np.bool_, tuple[int]]: ...
    @overload
    def __gt__(
        self: _SpArray2D,
        other: _spbase[_ToFloat, tuple[int, int]] | onp.ToFloat,
    ...
    @overload
    def __le__(self: _SpArray1D, other: _spbase[_ToFloat, tuple[int]] | onp.ToFloat, /) -> csr_array[np.bool_, tuple[int]]: ...
    @overload
    def __le__(
        self: _SpArray2D,
        other: _spbase[_ToFloat, tuple[int, int]] | onp.ToFloat,
    ...
    @overload
    def __ge__(self: _SpArray1D, other: _spbase[_ToFloat, tuple[int]] | onp.ToFloat, /) -> csr_array[np.bool_, tuple[int]]: ...
    @overload
    def __ge__(
        self: _SpArray2D,
        other: _spbase[_ToFloat, tuple[int, int]] | onp.ToFloat,
    ...
    @overload  # sparray[-Bool], /, other: array-like +Bool
    def dot(self: _SpArray, /, other: _DualArrayLike[bool, _ToBool]) -> onp.ArrayND[_SCT_co, _ShapeT_co]: ...
    @overload  # sparray[-Int], /, other: sparse +Int
    def dot(self: _SpArray[_FromInt], /, other: _spbase[_ToInt8 | _SCT_co]) -> _SpArrayOut[_SCT_co]: ...
    @overload  # sparray[-Int], /, other: array-like +Int
    def dot(self: _SpArray[_FromInt], /, other: _DualArrayLike[bool, _ToInt8]) -> onp.ArrayND[_SCT_co, _ShapeT_co]: ...
    @overload  # sparray[-Float], /, other: sparse +Float
    def dot(self: _SpArray[_FromFloat], /, other: _spbase[_ToFloat32 | _SCT_co]) -> _SpArrayOut[_SCT_co]: ...
    @overload  # sparray[-Float], /, other: array-like +Float
    def dot(self: _SpArray[_FromFloat], /, other: _DualArrayLike[int, _ToFloat32]) -> onp.ArrayND[_SCT_co, _ShapeT_co]: ...
    @overload  # sparray[-Complex], /, other: sparse +Complex
    def dot(self: _SpArray[_FromComplex], /, other: _spbase[_ToComplex64 | _SCT_co]) -> _SpArrayOut[_SCT_co]: ...
    @overload  # sparray[-Complex], /, other: array-like +Complex
    def dot(self: _SpArray[_FromComplex], /, other: _DualArrayLike[int, _ToComplex64]) -> onp.ArrayND[_SCT_co, _ShapeT_co]: ...
    @overload  # spmatrix, /, other: spmatrix
    def dot(self: _SpMatrixT, /, other: _SpMatrixT) -> _SpMatrixT: ...
    @overload  # spmatrix[-Bool], /, other: sparse +Bool
    def dot(self: spmatrix, /, other: _spbase[_ToBool]) -> _SpMatrixOut[_SCT_co]: ...
    @overload  # spmatrix[-Bool], /, other: array-like +Bool
    def dot(self: spmatrix, /, other: _DualArrayLike2d[bool, _ToBool]) -> onp.Array2D[_SCT_co]: ...
    @overload  # spmatrix[-Int], /, other: sparse +Int
    def dot(self: spmatrix[_FromInt], /, other: _spbase[_ToInt8]) -> _SpMatrixOut[_SCT_co]: ...
    @overload  # spmatrix[-Int], /, other: array-like +Int
    def dot(self: spmatrix[_FromInt], /, other: _DualArrayLike2d[bool, _ToInt8]) -> onp.Array2D[_SCT_co]: ...
    @overload  # spmatrix[-Float], /, other: sparse +Float
    def dot(self: spmatrix[_FromFloat], /, other: _spbase[_ToFloat32 | _SCT_co]) -> _SpMatrixOut[_SCT_co]: ...
    @overload  # spmatrix[-Float], /, other: array-like +Float
    def dot(self: spmatrix[_FromFloat], /, other: _DualArrayLike2d[int, _ToFloat32]) -> onp.Array2D[_SCT_co]: ...
    @overload  # spmatrix[-Complex], /, other: sparse +Complex
    def dot(self: spmatrix[_FromComplex], /, other: _spbase[_ToComplex64 | _SCT_co]) -> _SpMatrixOut[_SCT_co]: ...
    @overload  # spmatrix[-Complex], /, other: array-like +Complex
    def dot(self: spmatrix[_FromComplex], /, other: _DualArrayLike2d[float, _ToComplex64]) -> onp.Array2D[_SCT_co]: ...
    @overload  # spmatrix[+Bool], /, other: scalar- or matrix-like ~Int
    def dot(self: spmatrix[_ToBool], /, other: _spbase[Int]) -> _SpMatrixOut[Int]: ...
    @overload  # spmatrix[+Bool], /, other: array-like ~Int
    def dot(self: spmatrix[_ToBool], /, other: _DualArrayLike2d[opt.JustInt, Int]) -> onp.Array2D[Int]: ...
    @overload  # spmatrix[+Int], /, other: scalar- or matrix-like ~Float
    ...
    @overload
    def asformat(self: _SpArray1D, /, format: Literal["csr"], copy: bool = False) -> csr_array[_SCT_co, tuple[int]]: ...
    @overload
    def asformat(self: _SpArray2D, /, format: Literal["csr"], copy: bool = False) -> csr_array[_SCT_co, tuple[int, int]]: ...
    @overload
    ...
    @overload
    def asformat(self: _SpArray1D, /, format: Literal["dok"], copy: bool = False) -> dok_array[_SCT_co, tuple[int]]: ...
    @overload
    def asformat(self: _SpArray2D, /, format: Literal["dok"], copy: bool = False) -> dok_array[_SCT_co, tuple[int, int]]: ...
    @overload
    ...
    #
    @overload
    def tocsr(self: _SpArray1D, /, copy: bool = False) -> csr_array[_SCT_co, tuple[int]]: ...
    @overload
    def tocsr(self: _SpArray2D, /, copy: bool = False) -> csr_array[_SCT_co, tuple[int, int]]: ...
    @overload
    ...
    #
    @overload
    def todok(self: _SpArray1D, /, copy: bool = False) -> dok_array[_SCT_co, tuple[int]]: ...
    @overload
    def todok(self: _SpArray2D, /, copy: bool = False) -> dok_array[_SCT_co, tuple[int, int]]: ...
    @overload
