...
class _spbase(Generic[_SCT_co, _ShapeT_co]):
    ...
    @overload  # sparse[-Int], sparse[+Int8]
    def __sub__(self: _SPIntInT, other: _spbase[_ToInt8], /) -> _SPIntInT: ...
    @overload  # sparse[-Float], sparse[+Float32]
    def __sub__(self: _SPFloatInT, other: _spbase[_ToFloat32], /) -> _SPFloatInT: ...
    @overload  # sparse[-Complex], sparse[+Complex64]
    def __sub__(self: _SPComplexInT, other: _spbase[_ToComplex64], /) -> _SPComplexInT: ...
    @overload  # spmatrix[-Int], array[+Int8]
