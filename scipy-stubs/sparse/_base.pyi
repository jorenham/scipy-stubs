...
class _spbase(Generic[_SCT_co, _ShapeT_co]):
    ...
    def __iter__(self: csc_array[_SCT] | csr_array[_SCT], /) -> Iterator[csr_array[_SCT]]: ...
    @overload  # {csc,csr}_matrix
    def __iter__(self: csc_matrix[_SCT] | csr_matrix[_SCT], /) -> Iterator[csr_matrix[_SCT]]: ...
    @overload  # 1-d dok_array
    def __iter__(self: dok_array[_SCT, tuple[int]], /) -> Iterator[_SCT]: ...
    @overload  # dok_matrix
    ...
    @overload
    def __lt__(self: sparray, other: _spbase[_ToFloat] | onp.ToFloat, /) -> csr_array[np.bool_]: ...
    @overload
    ...
    @overload
    def __gt__(self: sparray, other: _spbase[_ToFloat] | onp.ToFloat, /) -> csr_array[np.bool_]: ...
    @overload
    ...
    @overload
    def __le__(self: sparray, other: _spbase[_ToFloat] | onp.ToFloat, /) -> csr_array[np.bool_]: ...
    @overload
    ...
    @overload
    def __ge__(self: sparray, other: _spbase[_ToFloat] | onp.ToFloat, /) -> csr_array[np.bool_]: ...
    @overload
    ...
    #
    @overload
    def tocoo(self: sparray, /, copy: bool = False) -> coo_array[_SCT_co, tuple[int, int]]: ...
    @overload
    ...
    #
    @overload
    def todok(self: sparray, /, copy: bool = False) -> dok_array[_SCT_co, tuple[int, int]]: ...
    @overload
