...
class _spbase(Generic[_SCT_co, _ShapeT_co]):
    ...
    @overload  # sparray[-Bool], /, other: sparse +Bool
    def dot(self: _SpArray, /, other: _spbase[_ToBool | _SCT_co]) -> _SpArrayOut[_SCT_co, _ShapeT_co]: ...
    @overload  # sparray[-Bool], /, other: array-like +Bool
    def dot(self: _SpArray, /, other: _DualArrayLike[bool, _ToBool]) -> onp.ArrayND[_SCT_co, _ShapeT_co]: ...
    @overload  # sparray[-Int], /, other: sparse +Int
    def dot(self: _SpArray[_FromInt], /, other: _spbase[_ToInt8 | _SCT_co]) -> _SpArrayOut[_SCT_co, _ShapeT_co]: ...
    @overload  # sparray[-Int], /, other: array-like +Int
    def dot(self: _SpArray[_FromInt], /, other: _DualArrayLike[bool, _ToInt8]) -> onp.ArrayND[_SCT_co, _ShapeT_co]: ...
    @overload  # sparray[-Float], /, other: sparse +Float
    def dot(self: _SpArray[_FromFloat], /, other: _spbase[_ToFloat32 | _SCT_co]) -> _SpArrayOut[_SCT_co, _ShapeT_co]: ...
    @overload  # sparray[-Float], /, other: array-like +Float
    ...
    def maximum(self: _ToCSRArray, /, other: _spbase[_SCT] | _SCT) -> csr_array[_SCT_co | _SCT, _ShapeT_co]: ...
    ...
    def maximum(self: sparray, /, other: onp.ToComplex) -> _SpArrayOut[Any, _ShapeT_co]: ...
    ...
    @overload  # other sparray, sparse or scalar
    def minimum(self: _ToCSRArray, /, other: _spbase[_SCT] | _SCT) -> csr_array[_SCT_co | _SCT, _ShapeT_co]: ...
    @overload  # other spmatrix, sparse or scalar
    ...
    @overload  # sparray, unknown scalar
    def minimum(self: sparray, /, other: onp.ToComplex) -> _SpArrayOut[Any, _ShapeT_co]: ...
    @overload  # spmatrix, unknown scalar
