...
class LaplacianNd(LinearOperator):
    ...
    def __init__(self, grid_shape: Untyped, *, boundary_conditions: str = "neumann", dtype: Untyped = ...) -> None: ...  # pyright: ignore[reportInconsistentConstructor]
...
class Sakurai(LinearOperator):
    n: Untyped
    def __init__(self, n: Untyped, dtype: Untyped = ...) -> None: ...  # pyright: ignore[reportInconsistentConstructor]
    def eigenvalues(self, m: Untyped | None = None) -> Untyped: ...
...
class MikotaM(LinearOperator):
    def __init__(self, shape: Untyped, dtype: Untyped = ...) -> None: ...  # pyright: ignore[reportInconsistentConstructor]
    def tobanded(self) -> Untyped: ...
    def tosparse(self) -> Untyped: ...
    def toarray(self) -> Untyped: ...
