...
from ._typing import Matrix, Scalar, ToShape
...
class _data_matrix(_spbase[_SCT_co], Generic[_SCT_co]):
    ...
    def __init__(
        self,
        /,
        arg1: _spbase[_SCT_co] | onp.CanArrayND[_SCT_co] | Sequence[onp.CanArrayND[_SCT_co] | Sequence[_SCT_co]],
    ) -> None: ...
    @overload
    def __init__(self: _data_matrix[np.float64], /, arg1: ToShape) -> None: ...
