...
# TODO(jorenham): support complex
@overload
def factorial(n: onp.ToInt, exact: _Truthy, extend: L["zero"] = "zero") -> _i: ...
@overload
def factorial(n: onp.ToIntND, exact: _Truthy, extend: L["zero"] = "zero") -> onp.ArrayND[np.int_]: ...
@overload
def factorial(n: onp.ToFloat, exact: _Falsy = False, extend: L["zero"] = "zero") -> _f8: ...
@overload
def factorial(n: onp.ToFloatND, exact: _Falsy = False, extend: L["zero"] = "zero") -> onp.ArrayND[_f8]: ...

# TODO(jorenham): support complex
@overload
def factorial2(n: onp.ToInt, exact: _Truthy, extend: L["zero"] = "zero") -> _i: ...
@overload
def factorial2(n: onp.ToIntND, exact: _Truthy, extend: L["zero"] = "zero") -> onp.ArrayND[np.int_]: ...
@overload
def factorial2(n: onp.ToFloat, exact: _Falsy = False, extend: L["zero"] = "zero") -> _f8: ...
@overload
def factorial2(n: onp.ToFloatND, exact: _Falsy = False, extend: L["zero"] = "zero") -> onp.ArrayND[_f8]: ...

# TODO(jorenham): support complex
@overload
def factorialk(n: onp.ToInt, k: onp.ToInt, exact: _Truthy, extend: L["zero"] = "zero") -> _i: ...
@overload
def factorialk(n: onp.ToIntND, k: onp.ToInt, exact: _Truthy, extend: L["zero"] = "zero") -> onp.ArrayND[np.int_]: ...
@overload
def factorialk(n: onp.ToFloat, k: onp.ToInt, exact: _Falsy = False, extend: L["zero"] = "zero") -> _f8: ...
@overload
def factorialk(n: onp.ToFloatND, k: onp.ToInt, exact: _Falsy = False, extend: L["zero"] = "zero") -> onp.ArrayND[_f8]: ...
