...
def jnyn_zeros(n: spt.AnyInt, nt: spt.AnyInt) -> _tuple4[_array_1d[_f8], _array_1d[_f8]]: ...
...
def ai_zeros(nt: spt.AnyInt) -> _tuple4[_array_1d[_f8], _array_1d[_f8]]: ...
def bi_zeros(nt: spt.AnyInt) -> _tuple4[_array_1d[_f8], _array_1d[_f8]]: ...
...
def kelvin_zeros(nt: spt.AnyInt) -> _tuple8[_array_1d[_f8], _array_1d[_f8]]: ...
