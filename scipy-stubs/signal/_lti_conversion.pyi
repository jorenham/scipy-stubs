...
_InSystemZPK: TypeAlias = tuple[_ArrayLikeComplex_co, _ArrayLikeComplex_co, onp.ToFloat]
...
def zpk2ss(z: _InVector, p: _InVector, k: onp.ToFloat) -> _OutSystemSS: ...
def ss2zpk(A: _InMatrix, B: _InMatrix, C: _InMatrix, D: _InMatrix, input: onp.ToInt = 0) -> _OutSystemZPK: ...
def ss2tf(A: _InMatrix, B: _InMatrix, C: _InMatrix, D: _InMatrix, input: onp.ToInt = 0) -> _OutSystemTF: ...
def cont2discrete(
