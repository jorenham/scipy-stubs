from ._filter_design import (
    ...
    freqz as freqz,
    freqz_zpk as freqz_zpk,
    normalize as normalize,
    tf2zpk as tf2zpk,
    zpk2tf as zpk2tf,
)
from ._lti_conversion import (
    abcd_normalize as abcd_normalize,
    cont2discrete as cont2discrete,
    ss2tf as ss2tf,
    ss2zpk as ss2zpk,
    tf2ss as tf2ss,
    zpk2ss as zpk2ss,
...
class lti(LinearTimeInvariant):
    def __new__(cls, *system) -> Untyped: ...
    ...
    def to_discrete(self, dt, method: str = "zoh", alpha: Untyped | None = None): ...
