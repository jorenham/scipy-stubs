...
class InterpolatedUnivariateSpline(UnivariateSpline):
    def __init__(self, x, y, w: Untyped | None = None, bbox=..., k: int = 3, ext: int = 0, check_finite: bool = False): ...

class LSQUnivariateSpline(UnivariateSpline):
    def __init__(self, x, y, t, w: Untyped | None = None, bbox=..., k: int = 3, ext: int = 0, check_finite: bool = False): ...
...
class SmoothBivariateSpline(BivariateSpline):
    ...
    degrees: Untyped
    def __init__(
        self, x, y, z, w: Untyped | None = None, bbox=..., kx: int = 3, ky: int = 3, s: Untyped | None = None, eps: float = 1e-16
    ): ...
...
class LSQBivariateSpline(BivariateSpline):
    ...
    degrees: Untyped
    def __init__(
        self, x, y, z, tx, ty, w: Untyped | None = None, bbox=..., kx: int = 3, ky: int = 3, eps: Untyped | None = None
    ): ...
...
class RectBivariateSpline(BivariateSpline):
    ...
    tck: Untyped
    degrees: Untyped
    def __init__(self, x, y, z, bbox=..., kx: int = 3, ky: int = 3, s: int = 0): ...
...
class SmoothSphereBivariateSpline(SphereBivariateSpline):
    ...
    tck: Untyped
    degrees: Untyped
    def __init__(self, theta, phi, r, w: Untyped | None = None, s: float = 0.0, eps: float = 1e-16): ...
    def __call__(self, theta, phi, dtheta: int = 0, dphi: int = 0, grid: bool = True) -> Untyped: ...
...
class LSQSphereBivariateSpline(SphereBivariateSpline):
    ...
    tck: Untyped
    degrees: Untyped
    def __init__(self, theta, phi, r, tt, tp, w: Untyped | None = None, eps: float = 1e-16): ...
    def __call__(self, theta, phi, dtheta: int = 0, dphi: int = 0, grid: bool = True) -> Untyped: ...
