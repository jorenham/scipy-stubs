...
class rv_frozen(Generic[_RVT_co]):
    ...
    @overload
    def stats(self, /, moments: _Moments1) -> _Scalar_f8 | _Arr_f8: ...
    @overload
    def stats(self, /, moments: _Moments2 = ...) -> _Tuple2[_Scalar_f8] | _Tuple2[_Arr_f8]: ...
    @overload
    def stats(self, /, moments: _Moments3) -> _Tuple3[_Scalar_f8] | _Tuple3[_Arr_f8]: ...
    @overload
    def stats(self, /, moments: _Moments4) -> _Tuple4[_Scalar_f8] | _Tuple4[_Arr_f8]: ...
...
class _rv_continuous_0(rv_continuous):
    ...
    @override
    def __call__(self, /, loc: _ArrLike_f8_co = 0, scale: _ArrLike_f8_co = 1) -> rv_continuous_frozen[Self]: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
    @override
    def freeze(self, /, loc: _ArrLike_f8_co = 0, scale: _ArrLike_f8_co = 1) -> rv_continuous_frozen[Self]: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
    @override  # type: ignore[override]
    @overload
