...
class rv_discrete(_rv_mixin, rv_generic):
    ...
    def __new__(
        ...
        values: tuple[_AnyArray_f8_in, _AnyArray_f8_in] | None = None,
        inc: int = 1,
        longname: LiteralString | None = None,
        shapes: LiteralString | None = None,
        seed: _Seed | None = None,
    ) -> Self: ...
    # NOTE: Mypy (still) doesn't conform to the typing spec for `__new__` (mypy==1.11.2).
    # @overload
    # def __new__(
    #     cls,
    #     /,
    ...
    @overload
    def cdf(self, /, k: _Scalar_f8_in, *args: _Scalar_f8_in, **kwds: _Scalar_f8_in) -> np.float64: ...
    @overload
    def cdf(self, /, k: _AnyArray_f8_in, *args: _AnyArray_f8_in, **kwds: _AnyArray_f8_in) -> _AnyArray_f8_out: ...
    @overload
    def logcdf(self, /, k: _Scalar_f8_in, *args: _Scalar_f8_in, **kwds: _Scalar_f8_in) -> np.float64: ...
    @overload
    def logcdf(self, /, k: _AnyArray_f8_in, *args: _AnyArray_f8_in, **kwds: _AnyArray_f8_in) -> _AnyArray_f8_out: ...
    @overload
    def sf(self, /, k: _Scalar_f8_in, *args: _Scalar_f8_in, **kwds: _Scalar_f8_in) -> np.float64: ...
    @overload
    def sf(self, /, k: _AnyArray_f8_in, *args: _AnyArray_f8_in, **kwds: _AnyArray_f8_in) -> _AnyArray_f8_out: ...
    @overload
    def logsf(self, /, k: _Scalar_f8_in, *args: _Scalar_f8_in, **kwds: _Scalar_f8_in) -> np.float64: ...
    @overload
    def logsf(self, /, k: _AnyArray_f8_in, *args: _AnyArray_f8_in, **kwds: _AnyArray_f8_in) -> _AnyArray_f8_out: ...
    def expect(
        self,
        /,
...
class rv_sample(rv_discrete, Generic[_XT_co, _PT_co]):
    ...
    @override
    def generic_moment(self, /, n: onpt.AnyIntegerArray | int | Sequence[int]) -> npt.NDArray[np.float64]: ...  # type: ignore[override]
