...
class multivariate_normal_frozen(multi_rv_frozen[multivariate_normal_gen]):
    ...
    def rvs(self, /, size: spt.AnyShape = 1, random_state: spt.Seed | None = None) -> onp.ArrayND[np.float64]: ...
...
class matrix_normal_frozen(multi_rv_frozen[matrix_normal_gen]):
    ...
    def logpdf(self, /, X: onp.ToFloatND) -> _ScalarOrArray_f8: ...
    def pdf(self, /, X: onp.ToFloatND) -> _ScalarOrArray_f8: ...
    def rvs(self, /, size: opt.AnyInt = 1, random_state: spt.Seed | None = None) -> onp.Array3D[np.float64]: ...
    def entropy(self, /) -> np.float64: ...
...
class wishart_frozen(multi_rv_frozen[wishart_gen]):
    ...
    def rvs(self, /, size: onp.ToJustInt | onp.AtLeast1D = 1, random_state: spt.Seed | None = None) -> _ScalarOrArray_f8: ...
    def entropy(self, /) -> np.float64: ...
...
class multinomial_gen(multi_rv_generic):
    def __call__(self, /, n: onp.ToJustIntND, p: _ToJustFloatND, seed: spt.Seed | None = None) -> multinomial_frozen: ...
...
class multinomial_frozen(multi_rv_frozen[multinomial_gen]):
    def __init__(self, /, n: onp.ToJustIntND, p: _ToJustFloatND, seed: spt.Seed | None = None) -> None: ...
    ...
    @overload
    def rvs(self, /, size: tuple[()], random_state: spt.Seed | None = None) -> onp.Array[onp.AtLeast1D, np.float64]: ...
    @overload
    def rvs(
        self,
        /,
...
class _group_rv_gen_mixin(Generic[_RVF_co]):
    def __call__(self, /, dim: onp.ToJustInt | None = None, seed: spt.Seed | None = None) -> _RVF_co: ...
    def rvs(
        self,
        /,
        dim: onp.ToJustInt,
...
class _group_rv_frozen_mixin:
    dim: onp.ToJustInt
    def __init__(self, /, dim: onp.ToJustInt | None = None, seed: spt.Seed | None = None) -> None: ...
    def rvs(self, /, size: onp.ToJustInt | None = 1, random_state: spt.Seed | None = None) -> onp.Array3D[np.float64]: ...
...
class uniform_direction_gen(multi_rv_generic):
    def __call__(self, /, dim: onp.ToJustInt | None = None, seed: spt.Seed | None = None) -> uniform_direction_frozen: ...
    def rvs(
        self,
        /,
        dim: onp.ToJustInt,
...
class random_correlation_frozen(multi_rv_frozen[random_correlation_gen]):
    ...
    def rvs(self, /, random_state: spt.Seed | None = None) -> onp.ArrayND[np.float64]: ...
...
class multivariate_t_frozen(multi_rv_frozen[multivariate_t_gen]):
    ...
    def rvs(self, /, size: tuple[()], random_state: spt.Seed | None = None) -> onp.Array1D[np.float64]: ...
    @overload
    def rvs(self, /, size: onp.ToJustInt | tuple[int] = 1, random_state: spt.Seed | None = None) -> onp.Array2D[np.float64]: ...
    @overload
...
class multivariate_hypergeom_frozen(multi_rv_frozen[multivariate_hypergeom_gen]):
    def __init__(self, /, m: onp.ToIntND, n: onp.ToJustInt | onp.ToJustIntND, seed: spt.Seed | None = None) -> None: ...
    def logpmf(self, /, x: onp.ToFloatND) -> _ScalarOrArray_f8: ...
    def pmf(self, /, x: onp.ToFloatND) -> _ScalarOrArray_f8: ...
    def mean(self, /) -> onp.Array[onp.AtLeast1D, np.float64]: ...
...
class random_table_gen(multi_rv_generic):
    def __call__(self, /, row: onp.ToJustIntND, col: onp.ToJustIntND, *, seed: spt.Seed | None = None) -> random_table_frozen: ...
...
class random_table_frozen(multi_rv_frozen[random_table_gen]):
    def __init__(self, /, row: onp.ToJustIntND, col: onp.ToJustIntND, *, seed: spt.Seed | None = None) -> None: ...
    def logpmf(self, /, x: onp.ToFloatND) -> _ScalarOrArray_f8: ...
    def pmf(self, /, x: onp.ToFloatND) -> _ScalarOrArray_f8: ...
...
class dirichlet_multinomial_frozen(multi_rv_frozen[dirichlet_multinomial_gen]):
    ...
    def __init__(self, /, alpha: onp.ToFloatND, n: onp.ToJustIntND, seed: spt.Seed | None = None) -> None: ...
...
class vonmises_fisher_gen(multi_rv_generic):
    ...
    def logpdf(self, /, x: onp.ToFloatND, mu: onp.ToFloat1D | None = None, kappa: opt.JustInt = 1) -> _ScalarOrArray_f8: ...
    def pdf(self, /, x: onp.ToFloatND, mu: onp.ToFloat1D | None = None, kappa: opt.JustInt = 1) -> _ScalarOrArray_f8: ...
    def entropy(self, /, mu: onp.ToFloat1D | None = None, kappa: opt.JustInt = 1) -> np.float64: ...
    def rvs(
        self,
        /,
        mu: onp.ToFloat1D | None = None,
...
class vonmises_fisher_frozen(multi_rv_frozen[vonmises_fisher_gen]):
    def __init__(self, /, mu: onp.ToFloat1D | None = None, kappa: opt.JustInt = 1, seed: spt.Seed | None = None) -> None: ...
    def logpdf(self, /, x: onp.ToFloatND) -> _ScalarOrArray_f8: ...
    def pdf(self, /, x: onp.ToFloatND) -> _ScalarOrArray_f8: ...
    def entropy(self, /) -> np.float64: ...
    def rvs(
