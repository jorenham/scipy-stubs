...
from typing import Any, Final, Generic, TypeAlias, overload, type_check_only
...
class random_table_gen(multi_rv_generic):
    @override
    def __call__(self, /, row, col, *, seed: _Seed | None = None) -> random_table_frozen: ...
    def logpmf(self, /, x: _ArrayLike_uif_nd, row, col) -> _ScalarOrArray_f8: ...
    def pmf(self, /, x: _ArrayLike_uif_nd, row, col) -> _ScalarOrArray_f8: ...
...
class random_table_frozen(multi_rv_frozen[random_table_gen]):
    def __init__(self, /, row, col, *, seed: _Seed | None = None) -> None: ...
    def logpmf(self, /, x: _ArrayLike_uif_nd) -> _ScalarOrArray_f8: ...
    def pmf(self, /, x: _ArrayLike_uif_nd) -> _ScalarOrArray_f8: ...
...
class dirichlet_multinomial_gen(multi_rv_generic):
    @override
    def __call__(self, /, alpha, n, seed: _Seed | None = None) -> dirichlet_multinomial_frozen: ...
    def logpmf(self, /, x: _ArrayLike_uif_nd, alpha, n) -> _ScalarOrArray_f8: ...
    def pmf(self, /, x: _ArrayLike_uif_nd, alpha, n) -> _ScalarOrArray_f8: ...
...
class dirichlet_multinomial_frozen(multi_rv_frozen[dirichlet_multinomial_gen]):
    alpha: Untyped
    n: Untyped
    def __init__(self, /, alpha, n, seed: _Seed | None = None) -> None: ...
    def logpmf(self, /, x: _ArrayLike_uif_nd) -> _ScalarOrArray_f8: ...
    def pmf(self, /, x: _ArrayLike_uif_nd) -> _ScalarOrArray_f8: ...
    def mean(self, /) -> Untyped: ...
...
class vonmises_fisher_gen(multi_rv_generic):
    @override
    def __call__(self, /, mu: Untyped | None = None, kappa: int = 1, seed: _Seed | None = None) -> vonmises_fisher_frozen: ...
    def logpdf(self, /, x: _ArrayLike_uif_nd, mu: Untyped | None = None, kappa: int = 1) -> _ScalarOrArray_f8: ...
    def pdf(self, /, x: _ArrayLike_uif_nd, mu: Untyped | None = None, kappa: int = 1) -> _ScalarOrArray_f8: ...
    def rvs(
        self,
        /,
    ...
    def entropy(self, /, mu: Untyped | None = None, kappa: int = 1) -> np.float64: ...
    def fit(self, /, x: _ArrayLike_uif_nd) -> Untyped: ...

class vonmises_fisher_frozen(multi_rv_frozen[vonmises_fisher_gen]):
    def __init__(self, /, mu: Untyped | None = None, kappa: int = 1, seed: _Seed | None = None) -> None: ...
    def logpdf(self, /, x: _ArrayLike_uif_nd) -> _ScalarOrArray_f8: ...
    def pdf(self, /, x: _ArrayLike_uif_nd) -> _ScalarOrArray_f8: ...
    def rvs(self, /, size: int | tuple[int, ...] = 1, random_state: _Seed | None = None) -> npt.NDArray[np.float64]: ...
    def entropy(self, /) -> np.float64: ...
