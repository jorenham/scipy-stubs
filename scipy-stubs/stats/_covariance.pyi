...
class Covariance(Generic[_SCT_co]):
    ...
    @staticmethod
    @overload
    def from_diagonal(diagonal: Sequence[_SCT] | onp.CanArray[Any, np.dtype[_SCT]]) -> CovViaDiagonal[_SCT]: ...
    @staticmethod
    ...
    @property
    def covariance(self, /) -> onp.Array[tuple[int, int], _SCT_co]: ...
    @property
...
class CovViaDiagonal(Covariance[_SCT_co], Generic[_SCT_co]):
    ...
    @overload
    def __init__(self, /, diagonal: Sequence[_SCT_co] | onp.CanArray[Any, np.dtype[_Scalar_uif]]) -> None: ...
