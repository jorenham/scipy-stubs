...
_Vector_b1: TypeAlias = onpt.Array[tuple[int], np.bool_]
_Vector_i0: TypeAlias = onpt.Array[tuple[int], np.int_]

_Scalar_f8: TypeAlias = float | np.float64
_Vector_f8: TypeAlias = onpt.Array[tuple[int], np.float64]
_Matrix_f8: TypeAlias = onpt.Array[tuple[int, int], np.float64] | _spbase | LinearOperator
