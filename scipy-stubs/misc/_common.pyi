...
@deprecated("will be completely removed in SciPy 1.12.0")
def ascent() -> onp.Array[tuple[Literal[512], Literal[512]], np.uint8]: ...
@deprecated("will be completely removed in SciPy 1.12.0")
def face(
    gray: bool = False,
) -> onp.Array[tuple[Literal[768], Literal[1024]] | tuple[Literal[768], Literal[1024], Literal[3]], np.uint8]: ...
@deprecated("will be completely removed in SciPy 1.12.0")
def electrocardiogram() -> onp.Array[tuple[Literal[108_000]], np.float64]: ...
