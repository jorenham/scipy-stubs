...
from typing import IO, Any, ClassVar, Final, Generic, Literal
...
def loadarff(f: FileLike | IO[str]) -> tuple[npt.NDArray[np.void], MetaData]: ...
...
def test_weka(filename: FileLike) -> None: ...
