...
from scipy._typing import FileLike, Untyped
...
def hb_read(path_or_open_file: io.IOBase | FileLike) -> csc_matrix: ...
def hb_write(path_or_open_file: io.IOBase | FileLike, m: spmatrix | sparray, hb_info: HBInfo | None = None) -> None: ...
