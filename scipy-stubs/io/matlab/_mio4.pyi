...
class MatFile4Reader(MatFileReader):
    ...
    def get_variables(self, /, variable_names: str | Sequence[str] | None = None) -> dict[str, npt.NDArray[np.generic]]: ...
    def list_variables(self, /) -> list[tuple[str, tuple[int, ...], str]]: ...

def arr_to_2d(arr: npt.NDArray[np.generic], oned_as: _OnedAs = "row") -> np.ndarray[tuple[int, int], np.dtype[np.generic]]: ...

class VarWriter4:
    file_stream: IO[bytes]
    oned_as: _OnedAs
    def __init__(self, /, file_writer: MatFile4Writer) -> None: ...
    def write_bytes(self, /, arr: npt.NDArray[np.generic]) -> None: ...
    ...
    def write_numeric(self, /, arr: npt.NDArray[np.number[Any]], name: str) -> None: ...
    def write_char(self, /, arr: npt.NDArray[np.character], name: str) -> None: ...
...
class MatFile4Writer:
    ...
    def put_variables(self, /, mdict: Mapping[str, npt.NDArray[np.generic]], write_header: bool | None = None) -> None: ...
